...
public class CustomListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView propertyNameChi = (TextView) convertView.findViewById(R.id.propertyNameChi);
        TextView propertyNameEng = (TextView) convertView.findViewById(R.id.propertyNameEng);
        ...
        propertyNameChi.setText(m.getPropertyNameChi());

        // Property Name English
        propertyNameEng.setText(String.valueOf(m.getPropertyNameEng()));
